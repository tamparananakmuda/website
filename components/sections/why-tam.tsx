...
import { Shield, Users, CheckCircle2, ArrowUpRight } from 'lucide-react';
...
export function WhyTam() {
  return (
    <section className="bg-card py-20 md:py-36 border-t border-border">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="mb-20">
          ...
          <div className="space-y-6 md:space-y-8">
            {differentiators.map((item, index) => (
              <div
                key={index}
                className="group flex flex-col gap-1 border-l-2 border-border pl-6 transition-all duration-200 hover:border-primary md:flex-row md:items-baseline md:gap-8 md:pl-8"
              >
                <p className="brush-strike text-base text-muted-foreground md:text-lg">
                  {item.negative}
                </p>
                <p className="font-display text-xl font-medium text-primary md:text-2xl transition-transform duration-200 group-hover:translate-x-1">
                  {item.positive}
                </p>
              </div>
            ))}
        ...
        {/* Editorial Commitment Sub-section with Interactive Bento Cards */}
        <div className="border-t border-border pt-16">
          <div className="mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div>
              <p className="mb-3 text-xs font-medium uppercase tracking-[0.25em] text-primary">
                Standar Jurnalistik TAM
              </p>
              <h3 className="max-w-2xl font-display text-2xl font-bold leading-snug tracking-tight md:text-3xl">
            ...
            <p className="max-w-md text-sm leading-relaxed text-muted-foreground">
              Setiap artikel dan seri melalui investigasi data independen, bebas kompromi algoritma, dan diverifikasi langsung ke sumber primer.
            </p>
          </div>

          {/* 6-Column Interactive Visual Bento Grid */}
          <div className="relative">
            <div className="relative z-10 grid grid-cols-6 gap-3 md:gap-4">
              
              {/* CARD 1: 100% Bebas Gimmick (col-span 2) */}
              <Card className="group relative col-span-full flex flex-col justify-between overflow-hidden border border-border/80 bg-background/50 backdrop-blur-sm transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5 lg:col-span-2">
                <CardContent className="relative m-auto flex size-fit flex-col items-center pt-8 pb-6 px-6">
                  <div className="relative flex h-24 w-56 items-center justify-center">
                    <svg
                      className="text-muted/60 dark:text-muted/40 absolute inset-0 size-full transition-transform duration-500 group-hover:scale-105"
                      viewBox="0 0 254 104"
                      fill="none"
                    ...
                    <span className="relative font-display text-5xl font-bold tracking-tight text-foreground transition-colors duration-300 group-hover:text-primary">
                      100%
                    </span>
                  </div>
                  ...
                  <p className="mt-2 text-center text-xs leading-relaxed text-muted-foreground">
                    Nol sponsor bayaran yang mendikte isi artikel. Pembaca adalah satu-satunya prioritas kami.
                  </p>
                </CardContent>
              </Card>

              {/* CARD 2: Verifikasi Data Primer / Radar Scanner (col-span 2) */}
              <Card className="group relative col-span-full overflow-hidden border border-border/80 bg-background/50 backdrop-blur-sm transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5 sm:col-span-3 lg:col-span-2">
                <CardContent className="flex h-full flex-col justify-between pt-6 pb-6 px-6">
                  <div className="relative mx-auto flex aspect-square size-32 items-center justify-center rounded-full border border-border before:absolute before:-inset-2 before:rounded-full before:border before:border-border/60 dark:border-white/10 dark:before:border-white/5 transition-transform duration-500 group-hover:scale-105">
                    <svg className="m-auto h-fit w-24" viewBox="0 0 212 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                
                        className="text-primary transition-transform duration-500 group-hover:scale-y-110"
                        d="M3 72H209"
                        stroke="currentColor"
                        strokeWidth="6"
                        strokeLinecap="round"
                      />
                      <defs>
                        <linearGradient id="paint_radar_why" x1="106.385" y1="1.34375" x2="106" y2="72" gradientUnits="userSpaceOnUse">
                          <stop stopColor="white" stopOpacity="0" />
                          <stop className="text-primary" offset="1" stopColor="currentColor" />
                        </linearGradient>
                        <clipPath id="clip_radar_why">
                  ...
                  <div className="relative z-10 mt-6 space-y-2 text-center">
                    <h4 className="font-display text-lg font-bold text-foreground transition-colors duration-300 group-hover:text-primary">
                      Verifikasi Data Primer
                    </h4>
                    <p className="text-xs leading-relaxed text-muted-foreground">
                      Setiap klaim ekonomi, angka statistik, dan hukum selalu disematkan rujukan sumber resmi yang bisa kamu audit.
                    </p>
                  </div>
                </CardContent>
              </Card>

              {/* CARD 3: Riset Mendalam / Waveform Curve (col-span 2) */}
              <Card className="group relative col-span-full overflow-hidden border border-border/80 bg-background/50 backdrop-blur-sm transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5 sm:col-span-3 lg:col-span-2">
                <CardContent className="flex h-full flex-col justify-between pt-6 pb-6 px-4">
                  <div className="pt-2">
                    <svg className="w-full transition-transform duration-500 group-hover:scale-[1.02]" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect width="386" height="123" rx="10" className="fill-muted/20 dark:fill-muted/10" />
                      <g clipPath="url(#clip_wave_why)">
                        <circle className="text-muted-foreground/60 dark:text-muted/60" cx="29" cy="29" r="15" fill="currentColor" />
                        ...
                        <text x="54" y="33" fill="currentColor" className="text-xs font-mono font-medium fill-foreground/70 tracking-wider">
                          TAM INVESTIGATIVE REPORT / 2026
                        </text>
                      </g>
                      <path
                        fillRule="evenodd"
                      ...
                      />
                      <defs>
                        <linearGradient id="paint_wave_fill_why" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                          <stop className="text-primary/20 dark:text-primary/30" stopColor="currentColor" />
                          <stop className="text-transparent" offset="1" stopColor="currentColor" stopOpacity="0.02" />
                        </linearGradient>
                        <clipPath id="clip_wave_why">
                  ...
                  <div className="relative z-10 mt-6 space-y-2 text-center">
                    <h4 className="font-display text-lg font-bold text-foreground transition-colors duration-300 group-hover:text-primary">
                      Bedah Realitas Sistemik
                    </h4>
                    <p className="text-xs leading-relaxed text-muted-foreground">
                      Bukan sekadar tips personal superficial, melainkan pembedahan komprehensif mengapa realitas ekonomi struktural berjalan seperti ini.
                    </p>
                  </div>
                </CardContent>
              </Card>

              {/* CARD 4: Koreksi Terbuka & Integritas / Candlestick SVG (col-span 3) */}
              <Card className="group relative col-span-full overflow-hidden border border-border/80 bg-background/50 backdrop-blur-sm transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5 lg:col-span-3">
                <CardContent className="grid h-full pt-6 pb-6 px-6 sm:grid-cols-2 gap-4">
                  <div className="relative z-10 flex flex-col justify-between space-y-8 lg:space-y-6">
                    <div className="relative flex aspect-square size-12 items-center justify-center rounded-full border border-border before:absolute before:-inset-1.5 before:rounded-full before:border before:border-border/60 dark:border-white/10 dark:before:border-white/5 transition-transform duration-300 group-hover:scale-110">
                      <Shield className="size-5 text-primary" strokeWidth={1.75} />
                    </div>
                    <div className="space-y-2">
                      <h4 className="font-display text-lg font-bold text-foreground transition-colors duration-300 group-hover:text-primary">
                        Koreksi Publik &amp; Transparansi
                      </h4>
                      <p className="text-xs leading-relaxed text-muted-foreground">
                        Jika terjadi kekeliruan data atau analisis, kami mempublikasikan ralat secara terbuka lengkap dengan riwayat revisi dan stempel waktu.
                      </p>
                      <div className="pt-2 flex items-center gap-2 text-xs font-medium text-primary">
                        <CheckCircle2 className="size-3.5" />
                        <span>Changelog &amp; Audit Trail Publik</span>
                      </div>
                    </div>
                  </div>

                  <div className="relative -mb-6 -mr-6 mt-4 sm:mt-0 h-fit rounded-tl-[var(--radius)] border-l border-t border-border bg-card/60 p-4 pt-6 sm:ml-4 transition-transform duration-500 group-hover:translate-x-1 group-hover:-translate-y-1">
                    <div className="absolute left-3 top-2 flex gap-1.5">
                      <span className="block size-2 rounded-full bg-red-500/80"></span>
                      <span className="block size-2 rounded-full bg-amber-500/80"></span>
                      <span className="block size-2 rounded-full bg-emerald-500/80"></span>
                    </div>
                    <svg className="w-full sm:w-[130%]" viewBox="0 0 366 231" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        ...
                        fill="url(#paint_candlestick_why)"
                      />
                      <path
                      ...
                      />
                      <defs>
                        <linearGradient id="paint_candlestick_why" x1="0.85108" y1="0.947876" x2="0.85108" y2="230.114" gradientUnits="userSpaceOnUse">
                          <stop className="text-primary/15 dark:text-primary/30" stopColor="currentColor" />
              ...
              {/* CARD 5: Jaringan Pembaca Kritis / Connector Nodes (col-span 3) */}
              <Card className="group relative col-span-full overflow-hidden border border-border/80 bg-background/50 backdrop-blur-sm transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5 lg:col-span-3">
                <CardContent className="grid h-full pt-6 pb-6 px-6 sm:grid-cols-2 gap-4">
                  <div className="relative z-10 flex flex-col justify-between space-y-8 lg:space-y-6">
                    <div className="relative flex aspect-square size-12 items-center justify-center rounded-full border border-border before:absolute before:-inset-1.5 before:rounded-full before:border before:border-border/60 dark:border-white/10 dark:before:border-white/5 transition-transform duration-300 group-hover:scale-110">
                    ...
                    <div className="space-y-2">
                      <h4 className="font-display text-lg font-bold text-foreground transition-colors duration-300 group-hover:text-primary">
                        Kolektif Pembaca Kritis
                      </h4>
                      <p className="text-xs leading-relaxed text-muted-foreground">
                        Komunitas puluhan ribu generasi muda yang aktif berdiskusi, bertukar perspektif, dan menolak kepalsuan narasi instan.
                      </p>
                      <div className="pt-2">
                        <Link
                          href="/tentang"
                        ...
                        >
                          <span>Kenali Redaksi &amp; Visi TAM</span>
                  ...
                  {/* Vertical Connector Line with Avatar Badges */}
                  <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-border sm:-my-6 sm:-mr-6">
                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                      ...
                      {/* Node 1 */}
                      <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2 group/node">
                        ...
                        <div className="ring-background size-8 ring-4 rounded-full overflow-hidden border border-border shadow-sm">
                      ...
                      {/* Node 2 */}
                      <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2 group/node">
                        <div className="ring-background size-9 ring-4 rounded-full overflow-hidden border border-primary/30 shadow-sm">
                          {/* eslint-disable-next-line @next/next/no-img-element */}
                          <img
                            className="size-full rounded-full object-cover"
