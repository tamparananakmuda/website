---
title: 'Situationship: Bukan Takut Komitmen, Gaji yang Tidak Pasti'
slug: hubungan-era-tidak-pasti-part-1-situationship-ekonomi
excerpt: >-
...
tags:
  ...
  - hubungan
  - pernikahan
ogHeadline: 'Gaji nggak pasti, tapi diminta janji selamanya?'
seoMetaTitle: 'Situationship Gen Z: Bukan Takut Komitmen, Ekonomi Beban | TAM'
seoMetaDescription: >-
  63% Gen Z menunda pernikahan karena ekonomi. Situationship bukan ketakutan,
  tapi respons rasional terhadap gaji yang tidak pasti. Baca datanya.
seoKeywords:
...
sourceReferences:
  - type: link
    ...
    label: IDN Research Institute (2025) - Alasan Gen Z tunda nikah
  - type: link
    url: >-
  ...
  - type: link
    ...
    label: 'Kompas.id - Situationship Gen Z (Hinge data, biaya kencan)'
  - type: link
    url: 'https://etd.repository.ugm.ac.id/penelitian/detail/275258'
    label: UGM Skripsi - Hubungan Tanpa Status Gen Z Urban (2026)
  - type: link
    url: >-
      https://kbr.id/articles/indeks/-takut-menikah-ini-masukan-relationship-coach-lex-depraxis-buat-gen-z
    label: KBR.id - Takut Menikah Gen Z (Coach Lex dePraxis)
  - type: link
    url: >-
...
```chart:bar
{"title":"Alasan Gen Z Menunda Komitmen","subtitle":"Persentase Gen Z yang menyebutkan alasan ini","source":"IDN Research Institute (2025) - Indonesia Millennial and Gen Z Report","data":[{"name":"Ketidakstabilan ekonomi","value":63,"color":"#ef4444"},{"name":"Fokus karier","value":51,"color":"#f4a825"},{"name":"Hidup bebas","value":47,"color":"#3b82f6"}]}
```
...
Konsekuensinya: komitmen terasa seperti opportunity cost yang terlalu tinggi. Kalau kamu mengikat diri dengan satu orang, kamu kehilangan akses ke ribuan "opsi lain" yang dijanjikan algoritma. Ini bukan ketakutan irasional. Ini rasionalitas di sistem yang didesain untuk membuat kamu terus swipe. Seperti yang dibahas di [Back to Basic Dating: Gen Z Capai Situationship, Bukan Konservatif](/artikel/back-to-basic-dating-bukan-konservatif-efisiensi-emosional), Gen Z tidak tiba-tiba konservatif. Mereka capai dengan situationship, ghosting, dan hubungan ambigu yang menguras energi.
...
**Selanjutnya di Hubungan Era Tidak Pasti:** Kalau situationship adalah respons rasional terhadap ekonomi tidak pasti, apa yang terjadi ketika hubungan yang sudah berjalan pun tidak bisa dipertahankan? Ghosting bukan tentang tidak bisa komunikasi. Tapi tentang tidak ada energi yang tersisa untuk maintain. [Lanjut ke Part 2](/artikel/hubungan-era-tidak-pasti-part-2-ghosting-bandwidth)
