---
title: 'Friendship Breakup: Pertemanan Jadi Luxury yang Tidak Terjangkau'
slug: hubungan-era-tidak-pasti-part-3-friendship-luxury
excerpt: >-
...
tags:
  ...
  - isolasi-sosial
  - kesepian
ogHeadline: Punya teman jadi mewah untuk generasi kelelahan
seoMetaTitle: 'Friendship Breakup Gen Z: Pertemanan Jadi Luxury | TAM'
seoMetaDescription: >-
  Remaja tanpa teman dekat naik 150% dalam 16 tahun. Friendship breakup bukan
  drama, tapi konsekuensi ekonomi yang membuat pertemanan jadi kemewahan.
seoKeywords:
  - friendship breakup gen z
  - quiet quitting friendship
  - pertemanan gen z Indonesia
  - remaja tanpa teman dekat
  - isolasi sosial gen z
sourceReferences:
  - type: link
  ...
  - type: link
    url: >-
      https://virallicious.id/fenomena-quiet-quitting-friendship-2026-saat-pertemanan-berakhir-tanpa-konflik-dan-drama/
    label: Virallicious (2026) - Quiet Quitting Friendship
  - type: link
    url: 'https://www.ghumi.id/2025/06/kesepian-di-tengah-keramaian-mengapa.html'
    label: 'Ghumi (2025) - Gen Z sulit punya teman, 8/10 merasa terisolasi'
  - type: link
    url: 'https://repository.unas.ac.id/id/eprint/16463/'
    label: UNAS (2026) - Pola Komunikasi Interpersonal Gen Z di Bumble
featured: false
humanSignature: true
...
> **Sebelumnya di Hubungan Era Tidak Pasti:** Part 2 membahas ghosting bukan sebagai kelemahan komunikasi, tapi sebagai mekanisme perlindungan diri ketika bandwidth emosional Gen Z sudah habis untuk survive ekonomi. Baca: [Part 2](/artikel/hubungan-era-tidak-pasti-part-2-ghosting-bandwidth)
...
```chart:bar
{"title":"Krisis Pertemanan dan Kesepian Remaja Indonesia","subtitle":"Perbandingan 2007 vs 2023 (GSHS WHO)","source":"GSHS WHO 2023 (via Kompas.id)","data":[{"name":"Tanpa teman dekat (per 1000) - 2007","value":14,"color":"#3b82f6"},{"name":"Tanpa teman dekat (per 1000) - 2023","value":35,"color":"#ef4444"},{"name":"Kesepian (%) - 2007","value":8.7,"color":"#3b82f6"},{"name":"Kesepian (%) - 2023","value":19,"color":"#ef4444"}]}
```
...
**Selanjutnya di Hubungan Era Tidak Pasti:** Kalau pertemanan pun jadi luxury, apa yang menggantikannya? Gen Z paling terhubung dalam sejarah manusia, tapi juga paling sendirian. Algoritma ganti teman, AI ganti terapis, tapi tidak ada yang ganti kehangatan. [Lanjut ke Part 4](/artikel/hubungan-era-tidak-pasti-part-4-kesepian-digital)
