---
title: "Kelas Menengah Indonesia: Tangga yang Dicabut"
slug: "kelas-menengah-indonesia-tangga-yang-dicabut"
subtitle: "Analisis struktural penyusutan kelas menengah Indonesia: upah stagnan, biaya hidup melonjak, PPN regresif, dan properti tidak terjangkau"
summary: "9.48 juta orang Indonesia turun dari kelas menengah dalam 5 tahun. 70% punya perencanaan keuangan yang sehat. Mereka tidak boros. Tangga yang dipanjat dipotong dari bawah."
...
dataSources:
  - "BPS Sakernas 2019-2025"
  - "World Bank Indonesia Economic Prospects December 2025"
  - "LPEM FEB UI 2025"
  - "Katadata Insight Center 2025"
  - "BPK Realisasi APBN 2024"
  - "Bank Indonesia SHPR Q4 2025"
  - "Bappenas 2024"
---

## Ide Whitepaper

**Judul working:** Kelas Menengah Indonesia: Tangga yang Dicabut
**Slug:** kelas-menengah-indonesia-tangga-yang-dicabut
**Masalah utama:** 9.48 juta orang Indonesia turun dari kelas menengah dalam 5 tahun. Narasi publik menyalahkan gaya hidup konsumtif, tapi data menunjukkan perilaku finansial kelas menengah sehat. Penyebab sebenarnya adalah sistem: upah stagnan, biaya hidup melonjak, PPN regresif, dan properti tidak terjangkau.
**Thesis:** Kelas menengah Indonesia tidak jatuh karena boros. Mereka jatuh karena tangga mobilitas sosial dipotong dari bawah.
**POV tag:** `kontra-narasi` + `data` + `tamparan`
**Target audience:** Policy makers (Bappenas, Kemenkeu, Kemnaker), ekonom, jurnalis ekonomi, kelas menengah urban usia 22-45
**Search intent:** Investigational + Decisional
**Goal:** Influence policy + authority building + kontra-narasi
**Estimasi word count:** 5.500 kata
...
- 9.48 juta orang turun dari kelas menengah (BPS, 2019-2024)
- Gaji tidak cukup untuk biaya hidup, terutama properti dan pendidikan
- KPR ditolak meski gaji di atas UMR
- Tabungan menipis, investasi turun

#### Lapis 2: Structural Problem
- Upah riil stagnan 0.6%/tahun sementara PDB tumbuh 4-5%/tahun
- Biaya hidup naik 3x lebih cepat dari gaji
- PPN bersifat regresif: 40.8% beban dari 18.8% populasi
- Properti tidak terjangkau: PIR 19.76x, KPR 9.38%

#### Lapis 3: Akar Masalah
- Struktur ekonomi berbasis upah rendah, 55% tenaga kerja informal
- Pertumbuhan ekonomi tidak terdistribusi ke pekerja
- Sistem perpajakan regresif (PPN dominan, bukan pajak progresif)
- Alokasi APBN: bunga utang > subsidi + bansos

#### Lapis 4: Stakeholder Mapping

| Stakeholder | Posisi | Detail |
|-------------|--------|--------|
| Pemerintah | Mengalihkan tanggung jawab | Narasi "kelas menengah boros" mengalihkan beban dari kebijakan |
| Platform konsumer | Normalisasi konsumsi | E-commerce, paylater target kelas menengah terjepit |
| Lembaga keuangan | Jual "solusi" produk | KPR, asuransi, investasi ke kelompok yang semakin tidak mampu |
| Developer properti | Harga tetap tinggi | Backlog 13 juta unit, supply terbatas |

#### Lapis 5: TAM Angle
"Kelas menengah tidak butuh pity party. Mereka butuh sistem yang berhenti mencabut tangga yang mereka panjat."
...
| Testable | Ya |
| Scope-limited | Ya |
| Actionable implication | Ya |

---

### Strategy Summary

**Narrative:** Provoke. Problem -> Data -> Reveal -> Pembongkaran narasi.
**Emotional arc:** Anxiety -> Surprise -> Awe.
**Hook:** "9.48 juta orang turun kasta. 70% punya perencanaan keuangan. Mereka tidak boros."
**Causal chain:** Struktur ekonomi -> Upah stagnan -> Biaya hidup naik -> Disposable income turun -> Kelas menengah turun kasta.
...
```chart:line
{"title":"Kelas Menengah Indonesia: Dari Naik ke Jatuh (2014-2025)","subtitle":"Proporsi kelas menengah terhadap total populasi","source":"BPS 2014-2024, Mandiri Institute 2025","data":[{"label":"2014","value":17.62},{"label":"2015","value":18.31},{"label":"2016","value":19.71},{"label":"2017","value":21.19},{"label":"2018","value":22.49},{"label":"2019","value":21.45},{"label":"2020","value":20.85},{"label":"2021","value":20.68},{"label":"2022","value":19.12},{"label":"2023","value":17.65},{"label":"2024","value":17.13},{"label":"2025","value":16.6}],"yLabel":"% Populasi","height":300}
```
...
```chart:bar
{"title":"Upah Riil vs PDB: Pertumbuhan Tidak Terdistribusi (2008-2024)","subtitle":"Upah riil turun dari 6.3% ke 0.6% per tahun, PDB tetap 4-5%","source":"LPEM FEB UI 2025, World Bank IEP 2025","data":[{"label":"Upah Riil 2008-2016","value":6.3,"color":"#22c55e"},{"label":"Upah Riil 2017-2024","value":0.6,"color":"#ef4444"},{"label":"PDB 2017-2024","value":4.5,"color":"#f4a825"}],"yLabel":"Pertumbuhan (%/tahun)","height":280}
```
...
```chart:bar
{"title":"19.76x: Butuh 20 Tahun Gaji untuk Beli Rumah di Jakarta","subtitle":"Rasio harga rumah vs gaji tahunan per kota","source":"BestBrokers 2024, LPEM FEB UI 2025","data":[{"label":"Medan","value":23.5,"color":"#ef4444"},{"label":"Surabaya","value":21.33,"color":"#ef4444"},{"label":"Batam","value":20.94,"color":"#ef4444"},{"label":"Makassar","value":19.78,"color":"#ef4444"},{"label":"Jakarta","value":19.76,"color":"#ef4444"},{"label":"Denpasar","value":16.9,"color":"#f4a825"},{"label":"Tangerang","value":15.77,"color":"#f4a825"},{"label":"Bogor","value":15.56,"color":"#f4a825"},{"label":"Malang","value":11.91,"color":"#22c55e"}],"yLabel":"PIR (x gaji tahunan)","height":320}
```
...
```chart:grouped-bar
{"title":"Jakarta 10.3x vs KL 4x: Jurang Keterjangkauan Properti ASEAN","subtitle":"PIR dan suku bunga KPR per negara ASEAN","source":"JPI 2025, Periskop 2025","data":[{"label":"Jakarta","PIR":10.3,"KPR":9.38},{"label":"Kuala Lumpur","PIR":4.0,"KPR":4.28},{"label":"Singapura","PIR":4.8,"KPR":2.93},{"label":"Bangkok","PIR":8.5,"KPR":5.82}],"series":[{"key":"PIR","name":"PIR (x gaji)","color":"#ef4444"},{"key":"KPR","name":"KPR (%)","color":"#f4a825"}],"yLabel":"Nilai","height":300}
```
...
Untuk pemahaman lebih detail tentang krisis keterjangkauan properti, baca artikel kami tentang [beli rumah bukan soal kopi, soal 25 tahun gaji tanpa makan](/artikel/uang/beli-rumah-bukan-soal-kopi-soal-25-tahun-gaji-tanpa-makan).
...
```chart:treemap
{"title":"Kelas Menengah Bayar 40.8% PPN, Padahal Cuma 18.8% Populasi","subtitle":"Distribusi beban PPN per kelompok pendapatan","source":"Next Policy 2024","data":[{"name":"Kelas Menengah","value":40.8,"color":"#ef4444"},{"name":"Kelas Atas","value":32.5,"color":"#f4a825"},{"name":"Kelas Bawah","value":18.2,"color":"#3b82f6"},{"name":"Lainnya","value":8.5,"color":"#22c55e"}],"height":280}
```
...
```chart:pie
{"title":"60% Gaji Habis untuk Pokok dan Cicilan","subtitle":"Komposisi pengeluaran kelas menengah Indonesia","source":"Katadata Insight Center, 2025","data":[{"name":"Kebutuhan Pokok","value":41,"color":"#ef4444"},{"name":"Cicilan","value":18.1,"color":"#f4a825"},{"name":"Tabungan","value":19.3,"color":"#22c55e"},{"name":"Lainnya","value":21.6,"color":"#3b82f6"}],"donut":true,"height":280}
```
...
Untuk konteks lebih luas tentang kenapa kerja keras tidak lagi menjamin stabilitas finansial, baca artikel kami tentang [generasi nanti dulu: bukan malas, gaji tidak mau tumbuh](/artikel/uang/generasi-nanti-dulu-bukan-malas-gaji-tidak-mau-tumbuh). Untuk pemahaman tentang kenapa menabung saja tidak cukup, baca [menabung irasional, bukan boros: matematika tidak masuk akal](/artikel/mindset/menabung-irasional-bukan-boros-matematika-tidak-masuk-akal).
...
```chart:bar
{"title":"Bunga Utang Rp 497.3T > Subsidi + Bansos Rp 443.2T","subtitle":"Alokasi APBN 2024 (Rp triliun)","source":"BPK Realisasi APBN 2024","data":[{"label":"Bunga Utang","value":497.3,"color":"#ef4444"},{"label":"Subsidi + Bansos","value":443.2,"color":"#f4a825"}],"yLabel":"Rp Triliun","height":280}
```
...
Untuk panduan praktis, baca [side hustle bukan ambisi, tapi kebutuhan ekonomi](/artikel/bisnis/side-hustle-bukan-ambisi-kebutuhan-ekonomi).
...
Untuk konteks lebih luas tentang hubungan pendidikan dan mobilitas sosial, baca whitepaper kami tentang [skill gap Indonesia: pendidikan tinggi jadi trap, bukan tangga](/whitepaper/skill-gap-indonesia-pendidikan-tinggi-jadi-trap-bukan-tangga).
...
**G1 Structure:** Semua heading conclusion-first. Topic sentence = claim. Pass.
**G2 Evidence:** Setiap claim punya data dengan source. 17 data points, 13 sources. Pass.
**G3 Tone:** TAM tone (jujur, rasional, berani). Human signature: Santi dan Ridha case study, "70% orang yang melakukan hal benar tetap gagal." No em dash. No AI pattern. Pass.

### Draft Completion Score

| Factor | Score |
|--------|-------|
| Word count (5.500) | 2 |
| Section completeness (8+) | 2 |
| Evidence density (17+) | 2 |
| Citation count (13+) | 2 |
| Human signature (2+) | 2 |
| Counter-argument (steel-manned) | 2 |
| Limitations (4 komponen) | 2 |
| Recommendation specificity | 2 |
| Front-loaded thesis | 2 |
| Internal links (5) | 2 |
| FAQ | 2 |
| Pull quotes (5+) | 2 |

**Total: 24/24.** Target min 11. Pass.

### Checklist

- [x] Dokumen lengkap ditulis
- [x] Word count: ~5.500 kata
- [x] Heading: h2/h3 only, 8 h2, tidak ada h1
- [x] Front-loaded thesis paragraph (paragraf pertama Executive Summary)
- [x] Citable passage: 5 self-contained extractable claims (upah, properti, PPN, perilaku, APBN)
- [x] Cognitive load: 1 idea per paragraph, bold key findings, pull quotes
- [x] Hedging: "menunjukkan" (strong), "cenderung" (moderate), "kemungkinan" (weak)
- [x] Plain language: Grade 9-10 exec summary, 11-12 analysis
- [x] Data journalism: nerd box di Methodology
- [x] Prospect theory: loss framing ("tangga dipotong", "turun kasta")
- [x] Nudge theory: options + consequences di recommendation
- [x] Narrative transportation: Santi dan Ridha case study
- [x] Barthes demystification: myth "kelas menengah boros" dibongkar
- [x] Limitations: 4 komponen (data gaps, method, generalizability, confounders)
- [x] Internal linking: 5 link ke konten TAM
- [x] Draft Quality Gates: G1, G2, G3 passed
- [x] Section-by-section: Analysis first, Exec Summary dari body
- [x] Evidence-Claim Mapping: 17 data points mapped
- [x] Paragraph Construction: 1 idea, topic sentence first, max 150 words
- [x] Counter-Argument: steel-man, acknowledge, data rebuttal, nuance, TAM close
- [x] Recommendation: Apa, Kenapa, Cara, Trade-off per rekomendasi
- [x] Self-Review: 10 questions answered
- [x] Draft Completion Score: 24/24
