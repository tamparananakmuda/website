---
title: "Menabung Jadi Irasional: Sistem Keuangan yang Didesain agar Kamu Rugi"
slug: "menabung-irasional-sistem-keuangan-yang-didesain-agar-kamu-rugi"
subtitle: "Bunga deposito 2,4%, inflasi 3,08%. Real return negatif. 127 tahun berhenti ngopi untuk beli rumah. Paylater 31,76 juta rekening vs reksadana 23,5 juta investor. Bukan Gen Z boros, matematikanya yang tidak masuk akal."
summary: "Bunga deposito 2,4%, inflasi 3,08%. Setiap tahun menabung, daya beli turun. 127 tahun berhenti ngopi untuk beli rumah. Bukan Gen Z boros, matematikanya yang tidak masuk akal."
coverImageUrl: null
...
dataSources:
  - BPS Sakernas (Aug 2024, Aug 2025, Feb 2026, Nov 2025) - upah buruh nasional, per sektor, per pendidikan
  - BPS IHK - inflasi tahunan (Des 2025, Jan 2026, Mar 2026, Mei 2026), inflasi per komponen
  - BPS IHPP 2024 - indeks harga properti residensial
  - Bank Indonesia - BI Rate, Survei Konsumen (saving ratio, konsumsi ratio, cicilan ratio)
  - OJK - paylater statistik (Jan, Mar, Mei 2026), reksadana data (Mar 2026), pinjaman online
  - KSEI - investor pasar modal (Apr 2026), investor aktif harian
  - LPS - bunga deposito, pajak bunga deposito
  - CPF Board Singapura - kontribusi CPF, return, home ownership
  - ATO Australia - superannuation guarantee 12%
  - Chant West - super fund returns FY26
  - OECD - home ownership international comparison
  - Pluang/CNN Indonesia - harga emas Antam 2020-2025
  - GoodStats - emas Antam naik 102% dalam 5 tahun
  - Deposito.co.id - perbandingan return instrumen 2025
  - CEIC - tabungan bruto Indonesia
---
...
```chart:bar
{"title":"Bunga Pinjaman vs Simpanan vs Inflasi","subtitle":"Sistem keuangan Indonesia: borrower bayar 12-24%, saver dapat 2-3%","source":"OJK, LPS, BPS, 2026","data":[{"label":"Bunga Pinjaman","value":18,"color":"#ef4444"},{"label":"Inflasi","value":3.08,"color":"#f4a825"},{"label":"Bunga Deposito Net","value":2.4,"color":"#3b82f6"}],"yLabel":"Persen (%)"}
```
...
```chart:line
{"title":"Daya Beli Rp100 Juta di Deposito: Turun Setiap Tahun","subtitle":"Bunga 2,4% vs inflasi 3,08% = rugi 0,68% per tahun","source":"LPS, BPS, 2026 (simulasi)","data":[{"label":"Tahun 0","value":100},{"label":"Tahun 2","value":98.6},{"label":"Tahun 4","value":97.3},{"label":"Tahun 6","value":96.0},{"label":"Tahun 8","value":94.7},{"label":"Tahun 10","value":93.8}],"yLabel":"Daya Beli (Rp juta)"}
```
...
Gen Z yang beli emas bukan karena tradisi, tapi karena mereka tidak percaya sistem finansial yang memberi 2,4% sementara emas naik 61% dalam setahun. Baca analisis lengkap di [Gen Z Beli Emas: Bukan Investasi Tradisional, Tidak Percaya Sistem Finansial](/artikel/gen-z-beli-emas-bukan-tradisi-tidak-percaya-sistem-finansial).
...
```chart:bar
{"title":"Gaji +1,83% vs Properti +2,76% vs Emas +10%","subtitle":"Gap 3-8x: gaji tidak kejar aset","source":"BPS Sakernas, BPS IHPP, Pluang, 2024-2026","data":[{"label":"Upah yoy","value":1.83,"color":"#3b82f6"},{"label":"Properti (BPS)","value":2.76,"color":"#f4a825"},{"label":"Properti (realitas)","value":10,"color":"#ef4444"},{"label":"Emas (avg)","value":10,"color":"#a855f7"},{"label":"Emas 2025","value":61,"color":"#ef4444"}],"yLabel":"Kenaikan per tahun (%)"}
```
...
```chart:bar
{"title":"Kredit 1 Klik, Investasi Butuh KYC","subtitle":"31,76 juta rekening paylater vs 23,5 juta investor reksadana vs 248 ribu aktif","source":"OJK, KSEI, 2026","data":[{"label":"Paylater (rekening)","value":31.76,"color":"#ef4444"},{"label":"Reksadana (investor)","value":23.5,"color":"#f4a825"},{"label":"Aktif harian","value":0.248,"color":"#3b82f6"}],"yLabel":"Juta orang"}
```
...
Bukan cuma Gen Z yang terjebak paylater. Artikel [Paylater Bukan Kemudahan, Penjaga Gaji Kamu](/artikel/paylater-bukan-kemudahan-penjaga-gaji-kamu) membahas bagaimana paylater dirancang untuk membuat kamu terus berutang. Dan [Girl Math Bukan Joke, Rasionalisasi Belanja Saat Nabung Tak Masuk Akal](/artikel/girl-math-bukan-joke-rasionalisasi-pengeluaran) menjelaskan kenapa rasionalisasi pengeluaran muncul saat menabung terasa tidak masuk akal.
...
Gen Z dibilang boros, padahal ekonomi tumbuh karena konsumsi mereka. Baca [Gen Z Dibilang Boros, Padahal Ekonomi Tumbuh karena Konsumsi Mereka](/artikel/gen-z-boros-atau-penyelamat-ekonomi) untuk analisis bagaimana konsumsi Gen Z justru menopang ekonomi.
...
```chart:grouped-bar
{"title":"CPF 37% vs Super 12% vs BPJS 3%: Sistem Tabungan Wajib","subtitle":"Kontribusi dan return: Indonesia paling sedikit dan paling tidak transparan","source":"CPF Board, ATO, BPJS, OECD, 2026","data":[{"label":"Singapura CPF","Kontribusi (%)":37,"Return (%)":3.25},{"label":"Australia Super","Kontribusi (%)":12,"Return (%)":9.5},{"label":"Indonesia BPJS","Kontribusi (%)":3,"Return (%)":0}],"series":[{"key":"Kontribusi (%)","name":"Kontribusi (% gaji)","color":"#f4a825"},{"key":"Return (%)","name":"Return tahunan (%)","color":"#3b82f6"}],"yLabel":"Persen (%)"}
```
...
Untuk analisis lebih lanjut tentang sistem pensiun Indonesia, baca whitepaper [Krisis Pensiun Generasi Muda: Menabung untuk Sistem yang Tidak Akan Ada](/whitepaper/krisis-pensiun-generasi-muda-sistem-yang-tidak-akan-ada). Dan untuk masalah perumahan, baca [Krisis Perumahan Gen Z: Sistem yang Didesain agar Kamu Tidak Bisa Beli](/whitepaper/krisis-perumahan-gen-z-sistem-yang-didesain-agar-tidak-bisa-beli).
...
Untuk panduan dana darurat yang realistis, baca [Dana Darurat 6x Gaji: Saran Finansial untuk Orang yang Sudah Makan](/artikel/dana-darurat-6x-gaji-saran-finansial-orang-yang-sudah-makan).
