...
export const categories: CategoryConfig[] = [
  ...
  { id: '62d4cac7-789f-4d35-9cd8-35f25a5bb042', title: 'Uang', slug: 'uang', description: 'Kelola, tumbuhkan, pahami.', color: '#A66315' },
];
...
export const series: SeriesConfig[] = [
  ...
  { id: 'd0e1f2a3-b4c5-6789-0abc-123456789abc', title: 'Sakit Itu Mahal: Tubuh yang Dijadikan Bisnis', slug: 'sistem-kesehatan-indonesia', description: 'Sistem kesehatan Indonesia tidak dirancang untuk membuatmu sehat, tapi untuk mengubah tubuhmu menjadi bisnis. 8 part membongkar kenapa BPJS defisit, kenapa dokter keluar negeri, kenapa obat mahal, dan kenapa sakit itu mahal bukan karena alam tapi karena desain.', status: 'scheduled', expectedDate: '2027-02-01', expectedParts: 8, teaser: 'BPJS defisit tiap tahun, dokter keluar negeri, obat mahal. Sistem kesehatan untuk siapa: yang sakit atau yang untung?' },
  { id: 'e6f7a8b9-c0d1-2345-abcd-901234567890', title: 'Pajak Indonesia: Gajimu Dipotong, Mereka Kabur', slug: 'sistem-pajak-indonesia', description: 'Setiap rupiah yang kamu hasilkan dipotong pajak sebelum masuk rekening. Setiap rupiah yang kamu belanjakan kena PPN 11%. Tapi konglomerat yang punya triliunan? Mereka dapat tax amnesty. 7 part membongkar kenapa sistem pajak Indonesia bukan gagal mengumpulkan, tapi didesain untuk transfer kekayaan dari kamu ke mereka.', status: 'scheduled', expectedDate: '2027-03-01', expectedParts: 7, teaser: 'Gajimu dipotong PPh 21, belanjamu kena PPN 11%. Tapi konglomerat? Mereka dapat tax amnesty. Sistem pajak untuk siapa: yang bayar atau yang kabur?' },
  { id: 'f7a8b9c0-d1e2-3456-bcde-901234567890', title: 'Kamu Marah, Mereka Untung: Sistem Media Indonesia', slug: 'sistem-media-indonesia', description: 'Media Indonesia tidak gagal memberitahu. Media didesain untuk membuat kamu marah. Karena marah = engagement = iklan. 7 part membongkar kenapa 6 grup media kontrol 90% berita Indonesia, kenapa ekonomi klik mengubah jurnalisme menjadi attention engineering, kenapa algoritma platform asing jadi editor utama, kenapa hoax bukan kesalahan tapi industri, kenapa influencer-jurnalis tanpa kode etik punya jangkauan lebih besar dari media mainstream, dan kenapa jurnalisme lokal mati membuat daerah tanpa suara. Sistem media untuk siapa: yang ingin tahu, atau yang untung dari ketidaktahuanmu?', status: 'scheduled', expectedDate: '2027-04-01', expectedParts: 7, teaser: 'Setiap kali kamu buka berita, kamu marah. Itu bukan kebetulan. Itu desain.' },
  { id: 'c3d4e5f6-a7b8-9012-cdef-345678901234', title: 'Pendidikan Mahal: Sekolah yang Tidak Mengajarkan Hidup', slug: 'pendidikan-mahal', description: 'Sekolah mengajarkan cara lulus ujian, bukan cara lulus hidup. Seri ini membongkar kenapa sistem pendidikan Indonesia membuat lulusan lebih siap jadi karyawan daripada hidup mandiri.', status: 'coming-soon', expectedDate: '2027-05-01', expectedParts: 8, teaser: 'Berapa banyak yang kamu bayar untuk gelar yang tidak menjamin apa-apa?' },
  { id: 'd4e5f6a7-b8c9-0123-def4-456789012345', title: 'Krisis Demografis Indonesia: Sistem yang Tidak Memberi Alasan Punya Anak', slug: 'krisis-demografis-indonesia', description: 'Gen Z tidak mau punya anak. Bukan egois, bukan hedonis. Mereka hitung dan tidak ada yang masuk akal. Seri ini membongkar kenapa sistem membuat punya anak jadi keputusan irasional.', status: 'coming-soon', expectedDate: '2027-06-01', expectedParts: 10, teaser: 'Kenapa Gen Z lebih punya kucing daripada anak?' },
];
