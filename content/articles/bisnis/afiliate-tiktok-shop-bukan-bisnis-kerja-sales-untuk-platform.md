...
```chart:bar
{"title":"Penghasilan Afiliator TikTok Shop per Tier","subtitle":"80% pemula di bawah Rp 2 juta/bulan","source":"Data agregat kreator Indonesia, 2026","data":[{"label":"Pemula","value":1.25,"color":"#ef4444"},{"label":"Junior","value":4,"color":"#f4a825"},{"label":"Mid-level","value":13,"color":"#22c55e"}],"yLabel":"Rp juta/bulan (rata-rata)","height":250}
```
