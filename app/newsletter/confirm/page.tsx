...
export const metadata: Metadata = {
  title: 'Konfirmasi Langganan - TAMPARAN ANAK MUDA',
  description: 'Konfirmasi langganan newsletter TAM',
        ...
        {isSuccess ? (
          <>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Kamu sudah masuk. Email welcome sudah dikirim ke inbox kamu. Satu sudut pandang baru setiap minggu, mulai minggu depan.
            </p>
          ...
          <>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Link konfirmasi ini tidak valid atau sudah kedaluwarsa. Coba daftar lagi.
            </p>
            <p className="mt-6 text-sm text-muted-foreground">
          ...
          <>
            ...
            <p className="text-muted-foreground">
              Tunggu sebentar, sedang mengkonfirmasi langganan kamu.
            </p>
          </>
        )}
      </div>
