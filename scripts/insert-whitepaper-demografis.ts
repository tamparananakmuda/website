...
const WHITEPAPER_FILE = 'content/whitepaper/krisis-demografis-indonesia-sistem-yang-tidak-memberi-alasan-punya-anak.md';
...
async function insert() {
  ...
  // Set status to scheduled with publishedAt 1 Februari 2027 08:00 WIB (01:00 UTC)
  const scheduledStatus = 'scheduled';
  const scheduledAt = '2027-02-01T01:00:00+00:00';
