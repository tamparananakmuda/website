...
const articleFiles = [
  {
    file: 'content/articles/mindset/delulu-bukan-solulu-delusi-menyerah-yang-dikemas-tren.md',
    categoryId: CATEGORY_MINDSET,
    subcategorySlug: 'tamparan',
  },
  {
    file: 'content/articles/uang/conscious-consumption-bukan-kesadaran-keharusan-ekonomi.md',
    categoryId: CATEGORY_UANG,
    subcategorySlug: 'keuangan-uang',
  },
  {
    file: 'content/articles/teknologi/tiktok-shop-bukan-belanja-algoritma-yang-bikin-kamu-kasir.md',
    categoryId: CATEGORY_TEKNOLOGI,
    subcategorySlug: 'teknologi-ai',
  },
];
